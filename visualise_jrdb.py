    ...
    def visualize_2d(self,
        ...
        for i, ts in tqdm(enumerate(timestamps)):
            ...
            if save_as_vid:
                ...
                cv2.imwrite('image.jpg', hsv_image)
                #cv2.waitKey(0)
...
def get_infos(root_dir="/mnt/d/JRDB/train_dataset_with_activity/train_dataset_with_activity",
...
if __name__ == '__main__':
    ...
    root_location = "/mnt/d/JRDB/train_dataset_with_activity"  # path to JRDB

    viz_kitti_submissions = False  # change the predictions_dir if set this to True
    predictions_dir = "/mnt/d/JRDB/train_dataset_with_activity/train_dataset_with_activity/detections/detections_3d"
    ...
    video_output_dir = '/home/annalena/PedestrianTrajectoryPrediction/videos'
